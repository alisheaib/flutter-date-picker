...
import 'package:syncfusion_flutter_datepicker/widgets/left_arrow_png.dart';
import 'package:syncfusion_flutter_datepicker/widgets/right_arrow_png.dart';
...
class SfDateRangePicker extends StatelessWidget {
  ...
  SfDateRangePicker(
      ...
      required this.activeDatesFontSize,
      required this.activeDatesFontFamily,
  ...
  final double activeDatesFontSize;
  final String activeDatesFontFamily;
  ...
  Widget build(BuildContext context) {
    return _SfDateRangePicker(
      ...
      activeDatesFontFamily: activeDatesFontFamily,
      activeDatesFontSize: activeDatesFontSize,
      daysColor: daysColor,
    );
  }
    ...
    return pickerTheme.copyWith(
        ...
        activeDatesTextStyle: pickerTheme.activeDatesTextStyle ??
            TextStyle(
              ...
              fontFamily: widget.activeDatesFontFamily,
              fontSize: widget.activeDatesFontSize,
              height: 1.34,
            ),
        disabledDatesTextStyle: TextStyle(
          color: widget.daysColor.withOpacity(0.2),
          fontFamily: widget.activeDatesFontFamily,
          fontSize: widget.activeDatesFontSize,
          height: 1.34,
        ),
...
class _PickerHeaderViewState extends State<_PickerHeaderView> {
  ...
  Widget build(BuildContext context) {
    ...
    final Container leftArrow =
        _getLeftArrow(arrowWidth, arrowColor, Colors.transparent, arrowSize);
...
class _PickerViewHeaderPainter extends CustomPainter {
  ...
  /// Defines the text style for daye (MON,TUE...)
  final TextStyle daysTextStyle;
